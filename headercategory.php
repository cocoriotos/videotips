...
<header>
  ...
  <center><nav class="navbar navbar-dark bg-dark d-flex justify-content-center align-items-center">
            ...
            <a id="headerfonts" href="videolinkadminmodule.php" class="btn" style="background-color: #D6EEFF; color: black; font-weight: bold;"><i class="fas fa-reply"></i> Adicionar enlaces</a>
