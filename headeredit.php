...
<header>
    ...
    <nav class="navbar navbar-dark bg-dark d-flex justify-content-between align-items-center">
              <div class="d-flex">
                    <a id="headerfonts" href="addcategory.php" class="btn" style="background-color: #FFF9CC ; color: black; font-weight: bold; margin-left: 10px;"><i class="fas fa-reply"></i> Category</a>
                    <a id="headerfonts" href="videolinkadminmodule.php" class="btn" style="background-color: #FFD6D6; color: black; font-weight: bold; margin-left: 10px;"><i class="fas fa-times"></i> Cancelar</a>
