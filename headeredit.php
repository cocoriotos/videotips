...
<header>
  <nav class="navbar navbar-dark bg-dark">
    ...
    <a href="videolinkadminmodule.php" class="btn" style="background-color: #FFF9CC; color: black; font-weight: bold;"><i class="fas fa-broom"></i> Ir a adicionar enlaces</a>
    <a href="addcategory.php" class="btn" style="background-color: #D6EEFF; color: black; font-weight: bold;"><i class="fas fa-reply"></i> Ir a adicionar enlaces</a>
