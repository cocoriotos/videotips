...
<header>
  ...
  <center><nav class="navbar navbar-dark bg-dark d-flex justify-content-center align-items-center">
	        <div class="text-center">
               ...
               <a id="headerfonts" href="videolinkadminmodule.php" class="btn" style=" background-color: #9A97F5; color: black; font-weight: bold;"><i class="fa fa-reply" aria-hidden="true"></i> Volver a la aplicación</a>
