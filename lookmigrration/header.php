...
<html lang="us"> 
  ...
  <nav class="navbar navbar-dark bg-dark d-flex justify-content-center" id="welcome" >
	    <center><a id="welcome" href="videolinkadminmodule.php" class="navbar-brand">Bienvenido  <span style="font-weight: bold; color: #ff0000;"><?php echo $name; ?></span> a tu Biblioteca de Contenidos Útiles</a></center>
  </nav>
