...
<html lang="us"> 
  ...
  <nav class="navbar navbar-dark bg-dark d-flex justify-content-between align-items-center" >
    ...
    <div class="d-flex">
        <a id="headerfonts" href="https://www.youtube.com/playlist?list=PLRQ5KF9igtB2GRlHLSP6Uwx1lzy387Wz5" class="btn" target="_blank" style="background-color: #c4302b; color: black; font-weight: bold; margin-right: 10px; margin-left: 20px;"><i class="fa fa-youtube-play" aria-hidden="true"></i> Tutoriales</a>
        <a id="headerfonts" href="UCLToolManualDelUsuario2025.pdf" class="btn" target="_blank" style="background-color:  #ff0000; color: black; font-weight: bold; margin-right: 10px; margin-left: 20px;"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Manual del Usuario</a>
    </div>
    <div class="d-flex">
