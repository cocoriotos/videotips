...
<html lang="us"> 
  ...
  <center>
    <a id="welcome" href="videolinkadminmodule.php" class="navbar-brand"><span class="username-style"><?php echo $name; ?></span>, Estás en tu Biblioteca de Contenidos Útiles</a>
</center>
  </nav>
