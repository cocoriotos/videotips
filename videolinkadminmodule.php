		...
		<div class="col-md-4"> 
			<div class="card card-body">
				<form class="" action="savelinks.php" method="POST"> 
					...
					<br><br>
					<center><input type="submit" class="btn btn-success btn-block" name="save_link" value="Save Link"></input></center><br><br>
					...
					<center><input type="submit" class="btn btn-success btn-block" name="logout" value="Refresh" formaction="videolinkadminmodule.php"></input></center><br><br>
					<center><input type="submit" class="btn btn-success btn-block" name="logout" value="Categories" formaction="addcategory.php"></input></center>
				</form>
			</div>
		</div>
