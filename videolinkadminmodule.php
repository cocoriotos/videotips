				...
				<table id="autosearch" class="display">
						...
						<tbody>
							...
							<tr>
								...
								<td><iframe width="360" height="115" src="<?php echo $embedUrl = str_replace("https://www.youtube.com/watch?v=", "https://www.youtube.com/embed/", $videoUrl); ?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></td>
