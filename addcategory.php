	...
	<div class="row">
		<div class="col-md-4"> 
			...
			<div class="form-group">
				...
				<label for="videolink" style="color: black;"><strong>Categorías para filtrar sus enlaces favoritos</strong></label><br>
					</div><br>
				...
				<form>
						...
						<center><input type="submit" class="btn btn-success btn-block" name="Refresh" value="Refrescar" formaction="addcategory.php"></input></center><br>
