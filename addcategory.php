		...
		<div class="col-md-4"> 
			...
			<div class="form-group">
				...
				<form>
						...
						<center><input type="submit" class="btn btn-success btn-block" name="Refresh" value="Refresh" formaction="addcategory.php"></input></center><br><br><br>
						<center><input type="submit" class="btn btn-success btn-block" name="cancel" value="Cancel" formaction="videolinkadminmodule.php"></input></center><br><br>
				</form>
			</div>
		</div>
