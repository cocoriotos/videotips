  ...
  <script src="copynumber.js"></script>
   <center><nav class="navbar navbar-dark bg-dark d-flex justify-content-center align-items-center">
	        <div class="text-center">
                ...
                <a id="headerfonts" href="suscriptionpayment.php" class="btn btn-dollar" style="background-color: #28A745; color: white; font-weight: bold;"><i class="fas fa-file-text"></i> Tarifas y pago por Nequi</a>
