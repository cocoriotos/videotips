...
<header>
  ...
  <center><nav class="navbar navbar-dark bg-dark d-flex justify-content-center align-items-center">
	        <div class="text-center">
                ...
                <a href="#" class="btn" style="background-color: blue; color: white; font-weight: bold;" onclick="copiarNumero();"><i class="fas fa-mobile-alt"></i> Copiar Número Tefónico para Nequi: 3054293185</a>
