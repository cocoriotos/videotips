...
<header>
  ...
  <center><nav class="navbar navbar-dark bg-dark d-flex justify-content-center align-items-center">
	        <div class="text-center">
                <center><input type="button" class="btn btn-success btn-block" value="Pago por Nequi" onclick="window.open('https://clientes.nequi.com.co/recargas', '_blank');"><i class="fas fa-sign-out-alt"></i></input></center><br><br>
                <a href=window.open('https://clientes.nequi.com.co/recargas', '_blank'); class="btn" style="background-color: blue; color: black; font-weight: bold;"><i class="fas fa-broom"></i> Pago por Nequi</a>
