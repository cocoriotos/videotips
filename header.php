...
<html lang="us"> 
  ...
  <nav class="navbar navbar-dark bg-dark d-flex justify-content-between align-items-center" style="padding: 0%; width: 99%;" >
    <div class="d-flex">
        ...
        <a id="headerfonts" href="#" class="btn" style="background-color: #d0fff8; color: black; font-weight: bold; margin-right: 10px; margin-left: 10px;" onclick="copiarNumero();"><i class="fas fa-mobile-alt"></i> Número Nequi: 3054293185</a>
