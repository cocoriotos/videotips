...
<header>
  <nav class="navbar navbar-dark bg-dark">
    ...
    <a href="videolinkadminmodule.php" class="btn" style="background-color: #D6EEFF; color: white; font-weight: bold;"><i class="fas fa-broom"></i> Categorías</a>
    <a href="videotrackerauth.php" class="btn btn-danger" style="background-color: #FFD6D6; color: white; font-weight: bold;"><i class="fas fa-sign-out-alt"></i> Salir</a>
