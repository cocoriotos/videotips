...
<header>
  ...
  <center><nav class="navbar navbar-dark bg-dark d-flex justify-content-center align-items-center">
	        <div class="text-center">
                ...
                <a href=window.open('https://clientes.nequi.com.co/recargas', '_blank'); class="btn" style="background-color: light-blue; color: black; font-weight: bold;"><i class="fas fa-dollar-sign"></i> Pago por Nequi</a>
