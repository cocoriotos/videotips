...
<header>
  ...
  <center><nav class="navbar navbar-dark bg-dark d-flex justify-content-center align-items-center">
	        <div class="text-center">
                ...
                <a href="#" class="btn" style="background-color: #28A745; color: white; font-weight: bold;" onclick="copiarNumero();"><i class="fas fa-mobile-alt"></i> Copiar Número Tefónico para Nequi: 3054293185</a>
                <a href="#" class="btn" style="background-color: #FFA500; color: white; font-weight: bold;" onclick="window.open('https://clientes.nequi.com.co/recargas', '_blank'); return false;"><i class="fas fa-dollar-sign"></i> Pago por Nequi</a>
