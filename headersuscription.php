...
<header>
  ...
  <center><nav class="navbar navbar-dark bg-dark d-flex justify-content-center align-items-center">
	        <div class="text-center">
               <input id="headerfonts1" type="button" class="btn btn-success btn-block" value="Cuenta Paypal: YSXRZMT2AAG4G" onclick="copiarPaypal();">  
               <input id="headerfonts1" type="button" class="btn btn-success btn-block" value="Ir a Paypal" onclick="window.open('https://www.paypal.com/', '_blank');"></input>
               <input id="headerfonts1" type="button" class="btn btn-success btn-block" value="Número Nequi: 3054293185" onclick="copiarNumero();">  
               <input id="headerfonts1" type="button" class="btn btn-success btn-block" value="Ir a Nequi" onclick="window.open('https://clientes.nequi.com.co/recargas', '_blank');"></input>
