...
<header>
  ...
  <center><nav class="navbar navbar-dark bg-dark d-flex justify-content-center align-items-center">
	        <div class="text-center">
                <a onclick="window.open('https://clientes.nequi.com.co/recargas', '_blank');" class="btn btn-success btn-block" ><i class="fas fa-dollar-sign"></i>Pago por Nequi</ar><br><br>
