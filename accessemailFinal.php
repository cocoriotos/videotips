...
$query1="INSERT INTO videotips_app_access_list (name, usename, email, password, role, active, adm_role, suscriptionactive, categorycounter, extendcounterfeature) VALUES ($name, concat($lastname,',',' ',$name), $email, $password, 'user', 1, 0, 1, 0, 0)"; 
