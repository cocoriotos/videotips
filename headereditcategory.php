...
<nav class="navbar navbar-dark bg-dark d-flex justify-content-between align-items-center">
    <div class="d-flex"></div>  
      <div class="d-flex">
          ...
          <a id="headerfonts" href="addcategory.php" class="btn" style="background-color: rgb(214, 243, 255); color: black; font-weight: bold; margin-right: 10px;"><i class="fa fa-link"></i> Categorías</a>  
