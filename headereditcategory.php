...
<div class="d-flex"></div>  
  <div class="d-flex">
      ...
      <a id="headerfonts" href="addcategory.php" class="btn" style="background-color: #FFD6D6; color: black; font-weight: bold; margin-right: 10px;"><i class="fas fa-times"></i> Cancelar</a>  
