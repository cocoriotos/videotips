...
?>
	...
	<body id="bodyadminmodule">		
			...
			<br>
				...
				<center><input name= "accept" type="checkbox" id="terms" onclick="toggleSubmitButton()" style="transform: scale(2); display: inline-block; margin-right: 10px;">   Acepto los <a href="termsConditions.php" target="_blank" style="color: white; display: inline-block; text-decoration: none;">términos y condiciones</a></input></center><br><br>
