...
?>
	...
	<body id="bodyadminmodule">		
			...
			<br>
			<div class="inputdata">
				<input  name= "accept" type="checkbox" id="terms" onclick="toggleSubmitButton()" style="transform: scale(2); "> Acepto los <a href="termsConditions.php" target="_blank" >términos y condiciones</a><br><br>
